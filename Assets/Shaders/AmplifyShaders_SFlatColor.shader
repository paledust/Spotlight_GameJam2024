	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 Emission = ( lerpResult24 + lerpResult27 );
				float3 Specular = 0.5;
				float Metallic = 0.0;
...
WireConnection;1;0;10;5
WireConnection;1;2;34;0
WireConnection;1;3;12;0
WireConnection;1;4;11;0
ASEEND*/
//CHKSM=BDABECD36EA0BE4ED58138B1EEC90C882CB31FF4